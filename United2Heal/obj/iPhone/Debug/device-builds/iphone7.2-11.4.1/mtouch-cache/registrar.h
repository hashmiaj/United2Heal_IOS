...
@class categoryCell;
@class United2Heal_itemPageViewModel;
@class United2Heal_BaseTableViewControllerBox;
@class boxCell;
@class United2Heal_ResultsTableControllerBox;
@class itemStatCell;
@class boxStatsListPage;
...
@interface United2Heal_BaseTableViewControllerBox : UITableViewController {
}
	-(void) release;
	-(id) retain;
	-(int) xamarinGetGCHandle;
...
@interface boxCell : UITableViewCell {
	...
	@property (nonatomic, assign) UILabel * boxName;
	-(void) release;
	-(id) retain;
	-(int) xamarinGetGCHandle;
	-(void) xamarinSetGCHandle: (int) gchandle;
	-(UILabel *) boxName;
	-(void) setBoxName:(UILabel *)p0;
	-(BOOL) conformsToProtocol:(void *)p0;
@end

@interface United2Heal_ResultsTableControllerBox : United2Heal_BaseTableViewControllerBox {
}
	-(NSInteger) tableView:(UITableView *)p0 numberOfRowsInSection:(NSInteger)p1;
	-(UITableViewCell *) tableView:(UITableView *)p0 cellForRowAtIndexPath:(NSIndexPath *)p1;
	-(id) init;
...
@interface itemStatCell : UITableViewCell {
}
	@property (nonatomic, assign) UILabel * itemName;
	@property (nonatomic, assign) UILabel * itemQuantity;
	-(void) release;
	-(id) retain;
	-(int) xamarinGetGCHandle;
	-(void) xamarinSetGCHandle: (int) gchandle;
	-(UILabel *) itemName;
	-(void) setItemName:(UILabel *)p0;
	-(UILabel *) itemQuantity;
	-(void) setItemQuantity:(UILabel *)p0;
	-(BOOL) conformsToProtocol:(void *)p0;
@end

@interface boxStatsListPage : UITableViewController {
}
	@property (nonatomic, assign) UITableView * boxStatsTableView;
	-(void) release;
	-(id) retain;
	-(int) xamarinGetGCHandle;
	-(void) xamarinSetGCHandle: (int) gchandle;
	-(UITableView *) boxStatsTableView;
	-(void) setBoxStatsTableView:(UITableView *)p0;
	-(void) viewDidLoad;
...
@interface itemPage : UIViewController {
	...
	@property (nonatomic, assign) UIPickerView * BoxPicker;
	@property (nonatomic, assign) UILabel * itemCategory;
	@property (nonatomic, assign) UILabel * itemCode;
	@property (nonatomic, assign) UILabel * itemName;
	...
	-(void) setBoxPicker:(UIPickerView *)p0;
	-(UILabel *) itemCategory;
	-(void) setItemCategory:(UILabel *)p0;
	-(UILabel *) itemCode;
	-(void) setItemCode:(UILabel *)p0;
...
@interface boxListController : UITableViewController {
}
	-(void) release;
	-(id) retain;
	-(int) xamarinGetGCHandle;
